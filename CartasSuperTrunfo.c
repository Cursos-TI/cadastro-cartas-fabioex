...
int main() {
    ...
    float superPoder1 = (float)(populacao1 + turisticos1 + area1 + pib1 + ( 1 / densidade1) + pibpc1); //ao final do cálculo, convertido em float para atender o comando da tarefa;
    ...
    float superPoder2 = (float)(populacao2 + turisticos2 + area2 + pib2 + ( 1 / densidade2) + pibpc2);
